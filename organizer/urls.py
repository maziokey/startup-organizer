...
from .views import NewsLinkCreate, NewsLinkUpdate, NewsLinkDelete, tag_list, tag_detail, TagCreate, TagDelete, TagUpdate, StartupCreate, StartupDelete, StartupUpdate, startup_detail, startup_list
